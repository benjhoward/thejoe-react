    ...
    return (
      <div>
        <nav>
          <div className="container">
            <div className="row nav-top">
              <div className="col-sm-6 nav-logo"><a href="/"><img src="../img/joe-nav.png" alt="The Joe"/></a><p>Hello, Coach Howard <i className="fa fa-cog" aria-hidden="true"></i></p></div>
        ...
        <section className="container other-scores">
          <div className="row">
            <div className="col-sm-6 game-matchup">
              <div className="row">
          ...
          <div className="row">
            <div className="col-sm-6 game-matchup" id="game-5">
              <div className="row">
                  <div className="col-sm-12 more-scores">
                    <div className="col-xs-2 np-right">
                      <img src="img/matchup/lynch.jpg" alt="Marshawn" className="score-mug"/>
